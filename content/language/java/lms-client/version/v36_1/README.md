...
### 훈련4: MariaDB에서 제공하는 Proxy를 사용하여 데이터 처리 작업을 수행할 DAO를 정의한다.
...
- com.eomcs.lms.handler.XxxAdd 변경한다.
- com.eomcs.lms.handler.XxxUpdate 변경한다.
- com.eomcs.lms.handler.XxxDelete 변경한다.