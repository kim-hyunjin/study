...
public class Exam0110 {
  public static void main(String[] args) throws Exception {
    ...
    // 예) Windows OS(MS949), Unix(UTF-8)
    //  - 만약 JVM을 실행할 때 "> java -Dfile.encoding=문자코드표" 옵션을 지정했다면
    //  - 해당 옵션에 지정된 문자코드로 변환하여 출력한다.
    //
    //  이 예제를 이클립스에서 실행하면
    //  다음 4바이트 값을 출력할때 앞의 2바이트는 버리고,
    //  뒤의 2바이트(UCS2)를 UTF-8코드표에 따라
    //  1 ~ 4 바이트 값으로 변환하여 출력한다.
    out.write(0x7a6bac00);
    // - 앞의 2바이트 7a6b버림
    // - 뒤의 2바이트 ac00씀. UCS2(ac00) => UTF-8(EA B0 80)
