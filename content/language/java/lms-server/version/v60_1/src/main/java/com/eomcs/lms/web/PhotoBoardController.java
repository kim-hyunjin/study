...
public class PhotoBoardController {
  ...
  @PostMapping("add")
  public String add(//
      int lessonNo, String title, MultipartFile[] photoFiles) throws Exception {
  ...
  public void list(int lessonNo, Model model) throws Exception {
    ...
    model.addAttribute("list", photoBoards);
  }

  @PostMapping("update")
  public String update(//
      int no, String title, MultipartFile[] photoFiles) throws Exception {
