...
public class Servlet01 extends GenericServlet {
  ...
  public void service(ServletRequest req, ServletResponse res)
    ...
    //
    // 테스트
    // - http://localhost:9999/bitcamp-java-web/ex04/s1 실행
    //
...
//    => 정적 파일의 실제 위치:
//       톰캣배치폴더/wtpwebapps/bitcamp-java-web/test01.html
//    => 요청:
...
// => request-URI 예)
// /bitcamp-java-web/ex04/s1?name=%ED%99%8D%EA%B8%B8%EB%8F%99&age=20
// 서블릿 URL : /bitcamp-java-web/ex04/s1
