...
const Treemap: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // 2. 트리맵 레이아웃 설정
    const treemapLayout = d3.treemap<DataNode>()
  ...
  return (
    <div className="p-4 bg-white rounded-xl shadow-md">
      <h2 className="text-xl font-bold text-gray-800 mb-2">트리맵 (Treemap)</h2>
      <p className="text-sm text-gray-600 mb-6">
        계층 구조의 데이터를 면적을 통해 표현합니다. 
        한정된 공간 안에 많은 정보를 밀도 있게 보여주며, 전체 대비 각 항목의 비중을 한눈에 파악하기 좋습니다.
        파일 시스템 사용량, 예산 배분 시각화 등에 자주 활용됩니다.
      </p>
