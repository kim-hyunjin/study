...
struct StoryBrain {
    ...
    var currentStory: Story {
        return self.stories[self.currentStoryNumber]
    }
    
    
    mutating func nextStory(userChoice: String) {
        let story = self.currentStory
        if story.choice1 == userChoice {
            self.currentStoryNumber = story.choice1Destination
        } else {
            self.currentStoryNumber = story.choice2Destination
        }
    }
