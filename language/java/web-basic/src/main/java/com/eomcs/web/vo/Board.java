...
public class Board implements Serializable {
  ...
  public String toString() {
    return "Board [no=" + no + ", contents=" + contents + ", date=" + createdDate + ", viewCount=" + viewCount
        + ", writer=" + writer + "]";
  }
  ...
  public String toCsvString() {
    return String.format("%d,%s,%s,%d,%s", this.getNo(), this.getContents(), this.getCreatedDate(),
