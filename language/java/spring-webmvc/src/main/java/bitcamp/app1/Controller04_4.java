...
public class Controller04_4 {
  ...
  //
  @InitBinder
  public void initBinder(WebDataBinder binder) { // requestHandler 호출 전에 파라미터 개수만큼 호출된다.
...
//    }
    ...
    public void setAsText(String text) throws IllegalArgumentException {
      ...
      try {
        ...
        //2) String ==> java.sql.Date (java.util.Date의 서브클래스이다.)
        setValue(java.sql.Date.valueOf(text)); // sql.Date은 'yyyy-MM-dd'형식만 가능
      } catch (Exception e) {
