...
module.exports = {
    ...
    target: "node", // node로 환경에서 실행될 것이라는 점을 명시
    output: {
        path: paths.ssrBuild, // 빌드 경로
        filename: "server.js", // 파일 이름
        chunkFilename: "js/[name].chunk.js", // 청크 파일 이름
        publicPath: paths.publicUrlOrPath // 정적 파일이 공될 경로
    },
    module: {
        rules: [
            {
                oneOf: [
                    ...
                    // url-loader를 위한 설정
                    {
                        ...
                        options: {
                            ...
                            limit: 10000, //원래는 9.76kb가 넘어가면 파일로 저장. emitFile이 false이므로 경로만 준비하고 파일은 저장하지 않는다.
